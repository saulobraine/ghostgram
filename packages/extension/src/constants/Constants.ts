...
// Valores originalmente de @ghostgram/shared, inlinados aqui porque Constants.ts
// é carregado no contexto da página (via chrome.runtime.getURL) onde bare specifiers
// como '@ghostgram/shared' não são resolvidos pelo browser.
